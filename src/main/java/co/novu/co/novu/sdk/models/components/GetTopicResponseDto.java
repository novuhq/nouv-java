...
public class GetTopicResponseDto {
    ...
    public GetTopicResponseDto withEnvironmentId(String environmentId) {
        Utils.checkNotNull(environmentId, "environmentId");
        this.environmentId = environmentId;
        return this;
    }

    public GetTopicResponseDto withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = Optional.ofNullable(id);
        return this;
    }

    public GetTopicResponseDto withId(Optional<? extends String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public GetTopicResponseDto withOrganizationId(String organizationId) {
        Utils.checkNotNull(organizationId, "organizationId");
        this.organizationId = organizationId;
        return this;
    }

    public GetTopicResponseDto withKey(String key) {
        Utils.checkNotNull(key, "key");
        this.key = key;
        return this;
    }

    public GetTopicResponseDto withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public GetTopicResponseDto withSubscribers(java.util.List<String> subscribers) {
        Utils.checkNotNull(subscribers, "subscribers");
        this.subscribers = subscribers;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetTopicResponseDto other = (GetTopicResponseDto) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetTopicResponseDto.class,
    ...
    public final static class Builder {
        ...
        public GetTopicResponseDto build() {
