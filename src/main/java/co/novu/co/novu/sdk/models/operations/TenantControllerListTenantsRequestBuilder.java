...
public class TenantControllerListTenantsRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallTenantControllerListTenants sdk;

    public TenantControllerListTenantsRequestBuilder(SDKMethodInterfaces.MethodCallTenantControllerListTenants sdk) {
        this.sdk = sdk;
    }
                
    public TenantControllerListTenantsRequestBuilder page(double page) {
        Utils.checkNotNull(page, "page");
        this.page = Optional.of(page);
        return this;
    }

    public TenantControllerListTenantsRequestBuilder page(Optional<? extends Double> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
                
    public TenantControllerListTenantsRequestBuilder limit(double limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = Optional.of(limit);
        return this;
    }

    public TenantControllerListTenantsRequestBuilder limit(Optional<? extends Double> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
                
    public TenantControllerListTenantsRequestBuilder retryConfig(co.novu.co.novu.sdk.utils.RetryConfig retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = Optional.of(retryConfig);
        return this;
    }

    public TenantControllerListTenantsRequestBuilder retryConfig(Optional<co.novu.co.novu.sdk.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = retryConfig;
        return this;
    }

    public TenantControllerListTenantsResponse call() throws Exception {
        if (limit == null) {
     ...
     **/  
    public Stream<TenantControllerListTenantsResponse> callAsStream() {
