...
public class FeedsControllerDeleteFeedByIdResponse implements co.novu.co.novu.sdk.utils.Response {
    ...
    @JsonCreator
    public FeedsControllerDeleteFeedByIdResponse(
            String contentType,
     ...
     * HTTP response content type for this operation
     */
    public FeedsControllerDeleteFeedByIdResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * Ok
     */
    public FeedsControllerDeleteFeedByIdResponse withFeedResponseDtos(java.util.List<co.novu.co.novu.sdk.models.components.FeedResponseDto> feedResponseDtos) {
        Utils.checkNotNull(feedResponseDtos, "feedResponseDtos");
     ...
     * Ok
     */
    public FeedsControllerDeleteFeedByIdResponse withFeedResponseDtos(Optional<? extends java.util.List<co.novu.co.novu.sdk.models.components.FeedResponseDto>> feedResponseDtos) {
        Utils.checkNotNull(feedResponseDtos, "feedResponseDtos");
        this.feedResponseDtos = feedResponseDtos;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public FeedsControllerDeleteFeedByIdResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public FeedsControllerDeleteFeedByIdResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        FeedsControllerDeleteFeedByIdResponse other = (FeedsControllerDeleteFeedByIdResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(FeedsControllerDeleteFeedByIdResponse.class,
    ...
    public final static class Builder {
        ...
        public FeedsControllerDeleteFeedByIdResponse build() {
            return new FeedsControllerDeleteFeedByIdResponse(
                contentType,
                feedResponseDtos,
                statusCode,
                rawResponse);
